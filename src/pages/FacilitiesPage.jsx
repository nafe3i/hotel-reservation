...
const facilities = [
  ...
  },
  {
    ...
    image: "/images/facilities/wifi.jpg",
  },
  {
    id: 3,
    name: "Spa & Wellness",
    icon: spaIcon,
    description:
      "Indulge in our luxurious spa treatments designed to rejuvenate your body and mind. Our skilled therapists offer a range of massages and beauty treatments.",
